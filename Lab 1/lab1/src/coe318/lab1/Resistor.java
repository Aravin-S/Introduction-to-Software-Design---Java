...
if((vvar>50.0)||(vvar<-50.0)){
    System.out.println("ERROR: Voltage Value is not within 50V and -50V.");
...
if((current>5.0)||(current<-5.0)){
    System.out.println("ERROR: Current Value is not within 5A and -5A.");  
}
