...
public class ComplexNumber {
  ...
  public ComplexNumber multiply(ComplexNumber z) {      
      ...
      ComplexNumber mult = new ComplexNumber((real * z.getReal() - imaginary * z.getImaginary()), real * z.getReal() + z.getReal() * z.getImaginary());
  ...
  public ComplexNumber reciprocal() {
      ...
      ComplexNumber reci = new ComplexNumber(real / (real * real + imaginary * imaginary), -imaginary / (real * real + imaginary * imaginary)); 
  ...
  public ComplexNumber divide(ComplexNumber z) {
      ...
      ComplexNumber div = new ComplexNumber((real*z.getReal() + imaginary * z.getImaginary()) / ((z.getReal() * z.getReal()) + (z.getImaginary() * z.getImaginary())), 
      ((imaginary * z.getReal()) - (real * z.getImaginary())) / ((z.getReal() * z.getReal()) + (z.getImaginary() * z.getImaginary())));
